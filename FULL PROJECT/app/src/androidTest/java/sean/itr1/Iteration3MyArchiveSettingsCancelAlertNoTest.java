...
public class Iteration3MyArchiveSettingsCancelAlertNoTest {
    @Rule
    public ActivityTestRule<AppSettings> AddSeriesActvityTestRule = new ActivityTestRule<>(AppSettings.class);

    // Issue: AlertDialog when cancelling my archive settings changes: Scenario 3
    @Test
    public void myArchiveSettingsCancelTest() {
        ...
        onView(withId(R.id.title_sort)).check(matches(isDisplayed()));
    }
}
